                ...
                <div className="p-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                        {filteredServices.map(service => (
                            ...
                            >
                                <div className="w-12 h-12 bg-white rounded-lg shadow-sm flex items-center justify-center p-2 border border-gray-100">
                                    <img src={getLogoUrl(service.slug)} alt={service.name} className="w-full h-full object-contain" />
                                </div>
                                <div>
                ...
                <div className="p-8">
                    <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
                        <div className="flex items-center gap-4">
                             <div className="w-16 h-16 bg-white rounded-xl shadow-sm flex items-center justify-center p-3 border border-gray-100">
                                <img src={getLogoUrl(selectedService.slug)} alt={selectedService.name} className="w-full h-full object-contain" />
                             </div>
                             <div>
