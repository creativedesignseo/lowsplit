---
description: Run the project's local verification pipeline. Use after any meaningful code change and before committing. Does not deploy.
---
...
- **Exit 1** — one or more checks failed. Do NOT commit, do NOT
  ...
  - Re-run that specific command in isolation for the full output.
